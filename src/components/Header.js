...
//   return (
//     <header className="fixed z-1000 w-screen  p-6 px-4 md:6 md:px-16">
...
//                     </p>
//                   </Link>
//                   <p className="px-4 py-2 bg-red-600 text-white flex items-center gap-3
...
//                   <p className="px-4 py-2 text-white flex items-center gap-3
//                    cursor-pointer bg-red-600 hover:bg-slate-200 transition-all
//                     duration-100 ease-in-out text-textColor text-base"
//                     onClick={logout}
//                     >
//                     Logout <MdLogout />
    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between ">
        <Link to={"/"} className="flex items-center gap-2 ">
          ...
          <p className="text-headingColor text-xl font-bold md:ml-2"> Food Fresh</p>
        </Link>
        ...
        <div className="flex items-center gap-8 ">
          ...
          >
            <li className="text-lg text-textColor hover:text-headingColor ml-10 duration-100 transition-all ease-in-out cursor-pointer">
              Home
            </li>
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "sadathsadu2002@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
